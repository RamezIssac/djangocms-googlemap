...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='googlemap',
            name='cmsplugin_ptr',
            field=models.OneToOneField(on_delete=models.CASCADE,parent_link=True, related_name='djangocms_googlemap_googlemap', primary_key=True, serialize=False, to='cms.CMSPlugin'),
        ),
        migrations.AlterField(
            model_name='googlemap',
            name='address',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(on_delete=models.CASCADE,parent_link=True, related_name='djangocms_googlemap_googlemapmarker', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
        ...
        migrations.CreateModel(
            name='GoogleMapRoute',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(on_delete=models.CASCADE,parent_link=True, related_name='djangocms_googlemap_googlemaproute', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
                ('title', models.CharField(max_length=255, verbose_name='Title', blank=True)),
